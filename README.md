[![Python CI](https://github.com/DevOps2-Fundamentals/python-app-joeblackA/actions/workflows/blank.yml/badge.svg)](https://github.com/DevOps2-Fundamentals/python-app-joeblackA/actions/workflows/blank.yml)
# Flask Product API
